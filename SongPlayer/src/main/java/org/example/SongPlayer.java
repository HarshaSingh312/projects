...
public class SongPlayer {
    ...
    // userId -> songs
    HashMap<String, LinkedHashSet<String>> userSongMap = new HashMap<>();
    ...
    public void play_song(String userId, String songId) {
        ...
        LinkedHashSet<String> set = userSongMap.getOrDefault(userId, new LinkedHashSet<>());
        set.remove(songId);
        set.add(songId);
        userSongMap.put(userId, set);
